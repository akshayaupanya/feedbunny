...
function setup() {
  ...
  button3.mouseClicked(drop3);
   ...
   // create air button
   button = createImg('balloon.png');
   button.position(20,200)
   button.size(100,100)
  // button.mouseClicked(air);
   //create mute button
  ...
  rope2 = new Rope(4,{x:145,y:30});
  rope3 = new Rope(9,{x:300,y:50});
...
{
  background(51);
  image(bg_img,0,0,displayWidth,displayHeight-300);
button.mouseClicked(air);
mute.mouseClicked(mutesound);
  push();
  imageMode(CENTER);
